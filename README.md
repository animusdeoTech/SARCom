...
| Gateway stack                                          | **Decided in part:** Rust binary on Yocto Linux, Dragino HAT for SX1276 + L80-M39 GNSS, single binary. `lora-phy` used on the gateway too (SX127x support). **Substrate is Pi 5** (variant TBD — 4 / 8 / 16 GB) per [`spikes/gateway-handheld-substrate-spike.md`](spikes/gateway-handheld-substrate-spike.md); CM5 / Pi 5 + USB SX1276 / Zero 2W remain on the spike's ranking. Pi 4 is retired (out of order; see [`dev-log/2026-05-07-pi4-retirement-substrate-decision.md`](dev-log/2026-05-07-pi4-retirement-substrate-decision.md)). Form factor + display class + battery + enclosure are open per pending ADR-015. See [ADR-004](decisions/ADR-004-gateway-platform.md). |
...
| Hardware in hand                                       | 3× Raspberry Pi 4 Model B — **out of order** (tested 2026-05-07; see [`dev-log/2026-05-07-pi4-retirement-substrate-decision.md`](dev-log/2026-05-07-pi4-retirement-substrate-decision.md)); substrate moves to Pi 5 (variant TBD per substrate spike + pending ADR-015). 1× 7" DSI touchscreen on hand. 3× Dragino HAT physically intact (some bent pins; GPIO 25 CS-defect rev check pending). **Heltec order #110639** placed 2026-05-05, **shipped 2026-05-07** via FedEx FIMS (#871462208618) — 10× Wireless Tracker V2 + 2× Solar Kit for Dev-board, $403.40, ETA ~3-7 working days from CN. Handheld-pivot peripherals (Pi 5, battery, 5"-class display, custom enclosure) not yet ordered — pending pivot spikes' close + ADR-015 / ADR-016 / ADR-017. |
