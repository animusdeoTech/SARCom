...
- [x] ~~Power-on test the 3× Pi 4 Model B units~~ — **done; all three confirmed out of order** (per [`dev-log/2026-05-07-pi4-dead-substrate-pivots-to-pi5.md`](dev-log/2026-05-07-pi4-dead-substrate-pivots-to-pi5.md)). Substrate moves to Pi 5; the dev-log A10-reframed contingency is satisfied.
...
- [ ] [`spikes/gateway-handheld-substrate-spike.md`](spikes/gateway-handheld-substrate-spike.md) — substrate ranking; feeds ADR-015. **Pi 4 fallback is dead** (per [`dev-log/2026-05-07-pi4-dead-substrate-pivots-to-pi5.md`](dev-log/2026-05-07-pi4-dead-substrate-pivots-to-pi5.md)); the live ranking is Pi 5 / Pi 5+USB SX1276 / CM5 / Zero 2W. Spike H0 (Pi 4 fallback) is empirically eliminated; spike body cleanup happens at its close.
