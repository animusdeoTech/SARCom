...
- **KIOSK-003:** Sidebar rows only; sticky `DISTRESS` section; rows ≥48 px; full-row selected tint; battery-low as inline `🔋 BATT` on primary line; mission-first sort preserved; no counter footer card; "Very-stale" row included.
